                ...
                if val != "-1":
                    ...
                    if type == "terrain":
                        terrain_tile_list = import_cut_graphics(
                            GRAPHICS_DIR / "terrain" / "terrain_tiles.png"
                        )
                    ...
                    if type == "grass":
                        grass_tile_list = import_cut_graphics(
                            GRAPHICS_DIR / "decoration" / "grass" / "grass.png"
                        )
                    ...
                    if type == "coins":
                        if val == "0":
                            sprite = Coin(tile_size, x, y, GRAPHICS_DIR / "coins" / "gold", 5)
                        if val == "1":
                            sprite = Coin(tile_size, x, y, GRAPHICS_DIR / "coins" / "silver", 1)

                    if type == "fg palms":
                        if val == "0":
                            sprite = Palm(
                                tile_size, x, y, GRAPHICS_DIR / "terrain" / "palm_small", 38
                            )
                        if val == "1":
                            sprite = Palm(
                                tile_size, x, y, GRAPHICS_DIR / "terrain" / "palm_large", 64
                            )
    ...
    def player_setup(self, layout, change_health):
        for row_index, row in enumerate(layout):
            for col_index, val in enumerate(row):
                ...
                if val == "0":
                    sprite = Player(
                        (x, y), self.display_surface, self.create_jump_particles, change_health
                    )
                    self.player.add(sprite)
                if val == "1":
                    hat_surface = pygame.image.load(
                        str(GRAPHICS_DIR / "character" / "hat.png")
                    ).convert_alpha()
