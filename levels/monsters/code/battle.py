...
class Battle:
    ...
    def create_monster(self, monster, index, pos_index, entity):
        ...
        level_pos = (
            name_sprite.rect.bottomleft if entity == "player" else name_sprite.rect.bottomright
        )
        MonsterLevelSprite(
            ...
            if keys[pygame.K_SPACE]:
                ...
                if self.selection_mode == "target":
                    ...
                    if self.selected_attack:
                        ...
                        self.selected_attack, self.current_monster, self.selection_mode = (
                            None,
                            None,
                            None,
                        )
                        ...
                        if (
                            ...
                            self.monster_data["player"][len(self.monster_data["player"])] = (
    ...
    def draw_general(self):
        for index, (_option, data_dict) in enumerate(BATTLE_CHOICES["full"].items()):
            ...
            if bg_rect.collidepoint(text_rect.center):
                if selected:
                    if text_bg_rect.collidepoint(bg_rect.topleft):
                        pygame.draw.rect(
                            self.display_surface, COLORS["dark white"], text_bg_rect, 0, 0, 5, 5
                        )
    ...
    def draw_switch(self):
        ...
        # monsters
        active_monsters = [
            (monster_sprite.index, monster_sprite.monster) for monster_sprite in self.player_sprites
        ]
