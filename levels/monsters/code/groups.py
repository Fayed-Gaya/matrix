...
class AllSprites(pygame.sprite.Group):
    def __init__(self):
        ...
        self.offset = vector()
        self.shadow_surf = import_image(GRAPHICS_DIR, "other", "shadow")
        self.notice_surf = import_image(GRAPHICS_DIR, "ui", "notice")
...
class BattleSprites(pygame.sprite.Group):
    ...
    def draw(
        self, current_monster_sprite, side, mode, target_index, player_sprites, opponent_sprites
    ):
